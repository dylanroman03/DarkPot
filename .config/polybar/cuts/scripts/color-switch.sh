...
 lime| orange| pink| purple| red| teal| yellow| wal| amber-dark|\
...
 green-light-dark| lime-dark| orange-dark| pink-dark| purple-dark| red-dark| teal-dark| yellow-dark| wal-dark|")"
            case "$MENU" in
				## Light Colors
				...
				*wal-dark) "$SDIR"/colors-dark.sh --wal
            esac
